...
if ! PGPASSWORD=coach psql -h localhost -U coach -d coachdb -tc \
  ...
  for f in coach/migrations/001_core.sql coach/migrations/003_targets_append_only.sql \
           coach/migrations/004_pgvector.sql coach/migrations/005_vitals.sql coach/migrations/006_food_entries.sql coach/migrations/007_cardio.sql coach/migrations/008_set_type.sql coach/migrations/009_food_macros.sql coach/migrations/010_meals.sql coach/migrations/011_measurements.sql; do
